...
function App() {
  return (
    <div className="App">
        <header>
            <div className="navbar text-green-100 bg-green-800">
                <div className="flex-1">
                    <a className="btn btn-ghost normal-case text-xl">BLUNTHEADZ</a>
                </div>
        ...
        <main>
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <img src="//external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOIP.5rfP9uiQt1OrZ8QLYHmUDgHaE3%26pid%3DApi&amp;f=1&amp;ipt=ee5a85717ac2176af895cc478026768517e8e7e785f1b9af2ebc37dee41f2777&amp;ipo=images" className="max-w-sm rounded-lg shadow-2xl" />
                    <div>
                        <h1 className="text-5xl font-bold">Tree of Life!</h1>
                        ...
                        <button className="btn bg-green-900">Get Started</button>
                    </div>
                </div>
            </div>
        </main>
        <footer className="absolute bottom-0 w-full">
            <div className="footer items-center p-4 bg-neutral text-green-300 text-neutral-content">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Copyright © 2023 - Bluntheadz All right reserved</p>
                </div>
